Languages.vi = {
    "values": [{
        ...
        "translation": "Planet GG (GameSpot) gần đây đã đăng một bài phỏng vấn với {0}. Theo bài phỏng vấn, công ty đang phát triển trò chơi đầu tiên nhắm đến đối tượng người chơi trưởng thành. {1}, chủ sở hữu và CEO của {0} cho biết, 'Chúng tôi nghĩ rằng người chơi đang tìm kiếm nhiều nội dung người lớn hơn trong game và chúng tôi sẵn sàng chấp nhận rủi ro để mang đến điều đó cho họ.'{n}"
    }, {
        ...
        "translation": "Dave Johnson đây, CEO của Departure Science (Aperture Science). Một số đối tượng thử nghiệm của chúng tôi gần đây đã tiếp xúc với một vài trò chơi của bạn và, thật ngạc nhiên, họ không hoàn toàn phát điên. Thực tế là họ có vẻ khá thích thú với trải nghiệm đó. Dù sao thì, tôi có một số sản phẩm cần quảng cáo và có thể sử dụng một chút quảng cáo sản phẩm.{n}Mấy cậu bé marketing của tôi nói rằng đưa ra lời đề nghị này cho bạn là một ý tưởng tồi nhưng đó chính xác là lý do tại sao tôi muốn nó. Tôi sẽ trả bạn {0} để đặt một vài thùng thuốc nổ sơn đỏ tuyệt đẹp của chúng tôi vào một trong những trò chơi của bạn. Bạn thấy sao?"
    }, {
        ...
        "comment": "see Portal 2 reference hint",
        "translation": "Departure Science (Aperture Science)"
    }, {
        ...
        "translation": "Trong một thông báo bất ngờ, {0}, một công ty nổi tiếng với các trò chơi như {1} đã tiết lộ rằng họ đang phát triển một máy chơi game của riêng mình. Máy chơi game này có tên là {2} được cho là sẽ cạnh tranh với các máy chơi game cao cấp từ các công ty như Mirconoft (Microsoft) và Vonny (Sony).{n}Chúng tôi rất nóng lòng muốn xem máy chơi game mới này sẽ có tác động lớn đến mức nào."
    }, {
        ...
        "value": "Grid income",
        "comment": "heading",
        "translation": "Thu nhập từ Grid (Steam)"
    }, {
        ...
        "translation": "Các nhà sản xuất phần cứng trên toàn thế giới đã rất ngạc nhiên hôm nay khi Govodore (Commodore), nhà sáng tạo ra G64 nổi tiếng, đã nộp đơn xin phá sản.{n}Govodore (Commodore) đã không thể giới thiệu một giải pháp thay thế giá cao hơn và buộc phải ngừng sản xuất G64. Nền tảng này sẽ rút khỏi thị trường {0}."
    }, {
        ...
        "translation": "Theo tin đồn, công ty Nhật Bản Ninvento (Nintendo) đang có kế hoạch ra mắt máy chơi game gia đình của riêng mình. Ninvento (Nintendo) nổi tiếng với trò chơi arcade rất thành công 'Dinkey King (Donkey Kong)'.{n}Nhiều chuyên gia trong ngành nghi ngờ rằng máy chơi game gia đình sẽ thành công nhưng chúng tôi rất nóng lòng muốn xem Ninvento (Nintendo) sẽ mang đến điều gì."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Ninvento (Nintendo) đã xác nhận những tin đồn gần đây và công bố kế hoạch phát hành một máy chơi game gia đình mới có tên 'TES (NES)' {0}.\nMáy chơi game này sử dụng các trò chơi dựa trên băng cạc-trít và một tay cầm điều khiển được thiết kế độc đáo."
    }, {
        ...
        "translation": "Máy chơi game gia đình TES (NES) mới được phát hành gần đây của Ninvento (Nintendo) đã chứng tỏ là một thành công lớn. Doanh số bán hàng đã vượt xa mong đợi.{n}Như một khách hàng nói: 'Tôi yêu thích các trò chơi đi kèm với TES (NES) và chơi bằng tay cầm điều khiển thú vị hơn nhiều so với trên bàn phím.'"
    }, {
        ...
        "translation": "Sau thành công vang dội của máy chơi game TES (NES), hiện đang có tin đồn lan truyền rằng Vena (Sega), một công ty Nhật Bản khác, đang có kế hoạch tự mình phát hành một máy chơi game gia đình."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Vena (Sega) đã xác nhận những tin đồn gần đây về một máy chơi game mới và công bố Master V (Master System).\nCông ty tuyên bố rằng Master V (Master System) vượt trội về mặt kỹ thuật so với TES (NES) cực kỳ thành công của Ninvento (Nintendo) và có kế hoạch phát hành nó {0}."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Ninvento (Nintendo) đã thông báo rằng họ sẽ giới thiệu một thiết bị chơi game cầm tay có tên là Gameling (Game Boy). Thiết bị này đi kèm với các băng trò chơi có thể thay đổi, màn hình đơn sắc trên nền xanh lá cây, loa tích hợp và thậm chí hỗ trợ nhiều người chơi thông qua cáp kết nối.{n}So với PC và các máy chơi game khác, Gameling (Game Boy) có cấu hình yếu hơn nhưng với chi phí thấp hơn và tính di động tuyệt vời, nó có thể thu hút một lượng lớn người theo dõi.{n}Gameling (Game Boy) được cho là sẽ lên kệ {0}."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Vena (Sega), nhà sản xuất máy chơi game Master V (Master System), đã công bố Vena (Sega) Gear (Sega Game Gear), một máy chơi game cầm tay để cạnh tranh trực tiếp với Gameling (Game Boy) của Ninvento (Nintendo).{n}Một phát ngôn viên của công ty cho biết, 'Không giống như các thiết bị tương tự trên thị trường không thể sánh được với máy chơi game, Vena (Sega) Gear (Sega Game Gear) về cơ bản có đầy đủ sức mạnh của Master V (Master System), ngoại trừ việc bạn có thể mang theo bên mình. Vena (Sega) Gear (Sega Game Gear) cũng có màn hình màu đầy đủ'.{n}Liệu thiết bị này có lật đổ được Gameling (Game Boy) không? Chúng ta sẽ xem. Vena (Sega) Gear (Sega Game Gear) sẽ ra mắt {0}."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Vena (Sega) đã thông báo rằng họ sẽ phát hành một máy chơi game mới {0}. Vena (Sega) Oasis (Sega Genesis) đi kèm với đồ họa và âm thanh 16-bit hứa hẹn một trải nghiệm chơi game mới mẻ.{n}Vena (Sega) cho biết tại buổi công bố, 'Oasis là một khởi đầu mới, nó sẽ là khởi nguồn của một thế hệ máy chơi game mới và chúng tôi tin rằng nó sẽ hoạt động rất tốt trên thị trường'. Một số trò chơi đã được công bố cho máy chơi game này cho thấy nó sẽ thu hút những đối tượng người chơi trưởng thành hơn."
    }, {
        ...
        "translation": "Hôm nay, Ninvento (Nintendo) đã công bố người kế nhiệm rất được mong đợi cho máy chơi game TES (NES) nổi tiếng. 'Đây là máy chơi game tuyệt vời nhất mà chúng tôi từng chế tạo. Nó đi kèm với đồ họa và âm thanh 16-bit tiên tiến nhất. Nó đơn giản là siêu phẩm và đó là lý do tại sao chúng tôi quyết định gọi nó là Super TES (NES) (Super NES)!'.{n}Người hâm mộ trên toàn thế giới đã chờ đợi khoảnh khắc này và có vẻ như họ sẽ không phải thất vọng."
    }, {
        ...
        "translation": "Giới truyền thông đang xôn xao với những tin tức mới nhất từ Hội nghị Giải trí năm nay. Trong một thông báo bất ngờ, Vonny (Sony), một công ty nổi tiếng về điện tử gia dụng đã giới thiệu một nguyên mẫu máy chơi game có tên là Play System (PlayStation).{n}Rõ ràng Vonny (Sony) đã hợp tác với Ninvento (Nintendo), nhà sản xuất các máy chơi game TES (NES) và Super TES (NES) (Super NES) được yêu thích và thành công, để phát triển một sản phẩm về cơ bản là Super TES (NES) (Super NES) có ổ đĩa CD.{n}Đây sẽ là máy chơi game đầu tiên trên thế giới sử dụng ổ đĩa CD."
    }, {
        ...
        "translation": "Các nhà báo trên toàn thế giới đang hoang mang vì chỉ một ngày sau khi Vonny (Sony) và Ninvento (Nintendo) cùng nhau công bố Play System (PlayStation) tại Hội nghị Giải trí, mọi chuyện đã trở nên tồi tệ.{n}Ninvento (Nintendo) hôm nay thông báo rằng họ sẽ hủy bỏ dự án và thay vào đó tìm cách phát triển một máy chơi game mới với một đối tác khác.{n}Có tin đồn rằng thỏa thuận phân phối mà các công ty đã đạt được không có lợi cho Ninvento (Nintendo) khi giao quá nhiều quyền kiểm soát cho Vonny (Sony).{n}Đây dường như là dấu chấm hết cho Play System (PlayStation)."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Vonny (Sony) đã công bố máy chơi game của riêng họ có tên là Playsystem (PlayStation). Rõ ràng công ty đã hoàn toàn làm lại nguyên mẫu Play System (PlayStation) trước đó của họ sau khi Ninvento (Nintendo) hủy bỏ dự án.{n}Playsystem (PlayStation) mới đi kèm với ổ đĩa CD-ROM và bộ xử lý 32-bit và hoàn toàn thuộc sở hữu của Vonny (Sony). Các chuyên gia trong ngành cho rằng đây có thể là sự khởi đầu của một thế hệ máy chơi game mới. Ninvento (Nintendo) từ chối bình luận. Playsystem (PlayStation) sẽ gia nhập thị trường {0}."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Ninvento (Nintendo) hôm nay đã công bố máy chơi game thế hệ tiếp theo của họ có tên là TES (NES) 64 (NES 64). Dự kiến {0}, đây là máy chơi game đầu tiên trên thế giới sử dụng bộ xử lý 64-bit cho đồ họa và âm thanh. Ninvento (Nintendo) cho biết điều này sẽ cho phép tạo ra độ chân thực 3D chưa từng thấy.{n}Trong những năm gần đây, Super TES (NES) (Super NES) đã mất rất nhiều thị phần vào tay các máy chơi game hiện đại hơn. Các chuyên gia thị trường cho biết phần cứng của TES (NES) 64 (NES 64) chắc chắn rất ấn tượng, nhưng bày tỏ sự ngạc nhiên rằng nó vẫn sử dụng băng ROM thay vì định dạng CD-ROM rẻ hơn nhiều và có dung lượng cao hơn.{n}Tuy nhiên, TES (NES) 64 (NES 64) có vẻ là một máy chơi game ấn tượng và Ninvento (Nintendo) cho biết họ có kế hoạch định giá cạnh tranh mạnh mẽ với Playsystem (PlayStation) của Vonny (Sony)."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Ngày mà người hâm mộ Vena (Sega) đã chờ đợi từ lâu đã đến, khi Vena (Sega) công bố máy chơi game thế hệ tiếp theo của họ, DreamVast (Dreamcast). Một phát ngôn viên của công ty cho biết, 'DreamVast (Dreamcast) là một giấc mơ trở thành hiện thực. Máy chơi game này là máy chơi game tiên tiến nhất trong lịch sử!'.{n}Máy chơi game mới này sở hữu phần cứng đồ họa mạnh mẽ hứa hẹn chất lượng đồ họa sánh ngang với các PC cao cấp. DreamVast (Dreamcast) cũng là máy chơi game đầu tiên được trang bị modem sẵn có, giúp nó sẵn sàng cho việc chơi trực tuyến. Máy chơi game sẽ có mặt trên thị trường {0}."
    }, {
        ...
        "translation": "Hôm nay, Vonny (Sony) đã công bố người kế nhiệm rất được mong đợi cho máy chơi game Playsystem (PlayStation) nổi tiếng của họ. Playsystem (PlayStation) 2 (PlayStation 2) sẽ có phần cứng được nâng cấp để cạnh tranh với các máy chơi game thế hệ mới hơn như DreamVast (Dreamcast).{n}Không giống như DreamVast (Dreamcast), Playsystem (PlayStation) 2 (PlayStation 2) không tập trung nhiều vào chơi trực tuyến mà thay vào đó dường như tập trung vào thế mạnh của Playsystem (PlayStation) trước đó. Một tay cầm điều khiển được nâng cấp chắc chắn bao gồm chức năng rung, đồ họa được nâng cấp, hỗ trợ các tựa game DVD và thậm chí cả khả năng tương thích ngược với các trò chơi Playsystem (PlayStation) 1."
    }, {
        ...
        "translation": "Kể từ khi phát hành, DreamVast (Dreamcast) của Vena (Sega) là một trong những máy chơi game bán chạy nhất trong lịch sử nhưng gần đây có vẻ như sự mong đợi về việc phát hành Playsystem (PlayStation) 2 (PlayStation 2) sắp tới đang làm chậm doanh số bán hàng.{n}Nếu Playsystem (PlayStation) 2 (PlayStation 2) có thể đáp ứng được sự kỳ vọng khi nó được phát hành thì Vena (Sega) có thể gặp rắc rối lớn."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Gã khổng lồ phần mềm PC Mirconoft (Microsoft) hôm nay đã thông báo rằng họ sẽ tham gia thị trường máy chơi game với máy chơi game của riêng mình có tên là mBox (Xbox).{n}Các buổi trình diễn đầu tiên rất ấn tượng, nhưng chúng ta sẽ phải chờ xem nó hoạt động như thế nào trước DreamVast (Dreamcast) nổi tiếng, cũng như trước Playsystem (PlayStation) 2 (PlayStation 2) mới được công bố gần đây và rất được mong đợi. Máy chơi game mới được cho là sẽ ra mắt {0}."
    }, {
        ...
        "translation": "Sự ra mắt của Playsystem (PlayStation) 2 (PlayStation 2) là một thành công phi thường. Các cửa hàng ở khắp mọi nơi đều hết hàng vì sản xuất hầu như không thể theo kịp. Người hâm mộ đã phải mua máy chơi game trên các trang đấu giá trực tuyến với giá cao gấp năm lần giá bình thường.{n}Trong khi Vonny (Sony) đã có màn ra mắt thành công nhất trong lịch sử, doanh số bán hàng của DreamVast (Dreamcast) của Vena (Sega) đã giảm mạnh."
    }, {
        ...
        "translation": "Trong một thông báo đáng buồn, Vena (Sega) hôm nay đã xác nhận việc ngừng sản xuất DreamVast (Dreamcast). Chủ tịch của Vena (Sega) cho biết mặc dù nhiều công ty vẫn sẽ cung cấp trò chơi cho nền tảng này, công ty sẽ không sản xuất các đơn vị mới trong tương lai nữa.{n}Người hâm mộ Vena (Sega) trên toàn thế giới thất vọng, vì một phần yêu thích của lịch sử máy chơi game sắp kết thúc."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Ninvento (Nintendo) đã công bố Ninvento (Nintendo) Game Sphere (GameCube) mới, với sản phẩm này, họ sẽ cố gắng cạnh tranh với Playsystem (PlayStation) 2 (PlayStation 2) đang dẫn đầu thị trường của Vonny (Sony) và giải pháp thay thế mạnh mẽ của Mirconoft (Microsoft), mBox (Xbox). Máy chơi game có hình dạng kỳ lạ này có thông số kỹ thuật phần cứng tương tự như các máy chơi game khác.{n}Game Sphere (GameCube) là máy chơi game đầu tiên của Ninvento (Nintendo) có ổ đĩa quang thay vì băng cạc-trít. Tuy nhiên, thay vì sử dụng đĩa CD và DVD kích thước đầy đủ như các đối thủ cạnh tranh, máy chơi game này lại có ổ đĩa mini-DVD. Game Spheres sẽ bắt đầu có mặt tại các cửa hàng {0}."
    }, {
        ...
        "translation": "Tin đồn đang lan rộng rằng Ninvento (Nintendo) đang phát triển một hệ máy chơi game mới. Hầu hết các tin đồn đều cho rằng đây không phải là người kế nhiệm của Game Sphere (GameCube) hơi đáng thất vọng mà là một hệ máy mới trên thị trường di động.{n}Gameling (Game Boy) của Ninvento (Nintendo) đã dẫn đầu thị trường di động nhờ nhiều bản cập nhật và danh sách lớn các trò chơi rất phổ biến có sẵn trên nền tảng này, nhưng phần cứng đang già đi nhanh chóng và nhiều người chơi tự hỏi điều gì sẽ xảy ra tiếp theo."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Vonny (Sony) đã công bố rằng họ sẽ ra mắt một hệ máy chơi game di động mới có tên là Portable Playsystem (PlayStation) (Sony PlayStation Portable), hay viết tắt là PPS (PSP), {0}. Các nhà phân tích truyền thông suy đoán rằng thông báo này nhằm đánh lạc hướng người dùng khỏi việc Ninvento (Nintendo) ra mắt Ninvento (Nintendo) GS (Nintendo DS).{n}Trong khi Ninvento (Nintendo) GS (Nintendo DS) sử dụng màn hình kép cải tiến, PPS (PSP) lại sử dụng một màn hình duy nhất và sẽ tập trung vào việc cung cấp cho các nhà phát triển quyền truy cập vào phần cứng mạnh mẽ hơn nhiều."
    }, {
        ...
        "translation": "Các chuyên gia trong ngành dự đoán rằng chúng ta sẽ thấy thế hệ máy chơi game tiếp theo sớm nhất là vào năm tới. 'Những tiến bộ về phần cứng trong ngành công nghiệp PC vẫn chưa được phản ánh trong các máy chơi game và chúng ta có thể kỳ vọng thế hệ tiếp theo sẽ là một bước nhảy vọt thực sự thú vị.'{n}Theo tin đồn, cả Mirconoft (Microsoft) và Vonny (Sony) đều đang chạy đua để giới thiệu hệ máy thế hệ tiếp theo, với Mirconoft (Microsoft) dường như đã hợp tác với các đối tác để chuẩn bị các tựa game cho hệ máy được gọi là 'mBox (Xbox) 360 (Xbox 360).'"
    }, {
        ...
        "translation": "Hôm nay, Mirconoft (Microsoft) đã giới thiệu hệ máy mới của họ có tên là mBox (Xbox) 360 (Xbox 360). Đây là hệ máy đầu tiên trong thế hệ máy chơi game được mong đợi tiếp theo, và có phần cứng cạnh tranh với các máy PC tầm trung. Với mức giá mua tương đối rẻ, Mirconoft (Microsoft) sẽ bán thiết bị này chịu lỗ như một phần của chiến lược dài hạn nhằm giành thị phần.{n}Các game thủ trên toàn thế giới rất hào hứng với hệ máy mới này và dự đoán rằng mBox (Xbox) 360 (Xbox 360) sẽ có tác động lớn đến thị trường console."
    }, {
        ...
        "translation": "Hôm nay, Ninvento (Nintendo) đã công bố sự tham gia của họ vào thị trường console thế hệ tiếp theo bằng việc công bố Nuu (Wii). Thay vì cố gắng cạnh tranh với Mirconoft (Microsoft) và Vonny (Sony) về sức mạnh phần cứng và đồ họa, Ninvento (Nintendo) đã quyết định mang đến một trải nghiệm chơi game thực sự độc đáo.{n}Nuu (Wii) có một bộ điều khiển với cảm biến chuyển động tích hợp, cho phép người chơi đứng trước TV và sử dụng bộ điều khiển như một vật thể ảo tương ứng, chẳng hạn như vợt tennis.{n}Những người chơi thử nghiệm đầu tiên đều nở nụ cười toe toét. Có vẻ như nó rất vui."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Vonny (Sony) đã công bố người kế nhiệm của Playsystem (PlayStation) 2 (PlayStation 2) cực kỳ thành công. Hệ máy mới này được dự đoán sẽ có tên là 'Playsystem (PlayStation) 3 (Sony PlayStation 3)' và đi kèm với cấu hình phần cứng ấn tượng, khiến nó trở thành hệ máy mạnh nhất trong lịch sử game.{n}Hệ máy này cũng có thể đóng vai trò như một đầu phát BlueRay, mà Vonny (Sony) hy vọng sẽ là người kế nhiệm của định dạng DVD. Tất cả sức mạnh này đi kèm với một mức giá đắt đỏ, cũng khiến Playsystem (PlayStation) 3 (Sony PlayStation 3) trở thành hệ máy đắt nhất từ trước đến nay.{n}Chúng ta sẽ xem người tiêu dùng phản ứng thế nào với điều này khi có các lựa chọn thay thế chi phí thấp hơn; tuy nhiên, xét đến thành công vang dội của Playsystem (PlayStation) 2 (PlayStation 2), Vonny (Sony) có thể hy vọng.\nHệ máy dự kiến sẽ được xuất xưởng {0}."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Trong một động thái mà một số người gọi là sự kiêu ngạo kỳ quái, đại diện của Vonny (Sony) đã nói xấu mBox (Xbox) 360 (Xbox 360) thành công của Mirconoft (Microsoft) trong khi ca ngợi Playsystem (PlayStation) 3 (Sony PlayStation 3) sắp ra mắt của chính họ trước thềm buổi ra mắt {0}.{n}Khi được hỏi về mức giá cao bất thường của Playsystem (PlayStation) 3 (Sony PlayStation 3), một quan chức cấp cao của công ty đã trả lời: 'Mọi người sẽ làm việc nhiều giờ hơn để mua một chiếc. Chúng tôi muốn mọi người cảm thấy rằng họ muốn nó hơn bất cứ thứ gì khác.'.{n}Chúng tôi không chắc liệu người chơi có thực sự muốn nó đến vậy không, vì cho đến nay, chưa có tựa game lớn nào được công bố cho Playsystem (PlayStation) 3 (Sony PlayStation 3). Có thể sẽ mất một thời gian trước khi các nhà phát triển có thể tận dụng tối đa sức mạnh của hệ máy mới này."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Hôm nay, Grapple (Apple), một công ty nổi tiếng với vai trò của họ trong ngành công nghiệp PC thời kỳ đầu và gần đây hơn là máy nghe nhạc di động grPod, đã thông báo rằng họ sẽ sớm phát hành một chiếc điện thoại di động mới mạnh mẽ. Chiếc điện thoại này có màn hình cảm ứng và sở hữu một CPU mạnh mẽ đáng ngạc nhiên.{n}Chipset đồ họa tích hợp cũng cho phép điện thoại chạy game và vì điện thoại đi kèm với nền tảng phân phối ứng dụng riêng, nó có thể trở thành một thiết bị tuyệt vời cho game di động. grPhone (iPhone) sẽ có mặt trên thị trường {0}."
    }, {
        ...
        "translation": "Hôm nay, Grapple (Apple), công ty chịu trách nhiệm cho chiếc grPhone (iPhone) cực kỳ thành công, đã công bố kế hoạch phát hành một thiết bị máy tính bảng có tên là grPad (iPad). Máy tính bảng không phải là một ý tưởng mới trong ngành công nghiệp máy tính nhưng những nỗ lực trước đó dường như chưa bao giờ thành công. Nhiều người kỳ vọng grPad (iPad) sẽ hoạt động rất tốt."
    }, {
        ...
        "translation": "mPad (Microsoft Surface) đã nhận được nhiều đánh giá trái chiều khi ra mắt, nhiều trong số đó nhấn mạnh thực tế rằng mPad (Microsoft Surface) thực sự không giống với grPad (iPad) của Grapple (Apple). Chúng ta sẽ xem tương lai sẽ ra sao với nền tảng này."
    }, {
        ...
        "comment": "{0} is date referal sentence fragment",
        "translation": "Đối với những người hâm mộ mBox (Xbox), sự chờ đợi một bản cập nhật cho hệ máy này sẽ sớm kết thúc khi Mirconoft (Microsoft) đã thông báo rằng mBox (Xbox) Next (Xbox Series X/S) sẽ có mặt {0}."
    }, {
        "value": " Mirconoft has lost a substantial share of the market since {0} released their {1} console.{n}",
        "translation": " Mirconoft (Microsoft) đã mất một phần đáng kể thị phần kể từ khi {0} phát hành hệ máy {1} của họ.{n}"
    }, {
        ...
        "translation": "Hệ máy mới dường như tích hợp một cách thông minh cảm biến chuyển động bổ trợ của Mirconoft (Microsoft) cho mBox (Xbox) vào một gói nhỏ gọn. Sức mạnh của phần cứng có vẻ đáp ứng được kỳ vọng."
    }, {
        ...
        "translation": "Kính gửi {0},\nChúng tôi đã theo dõi sự tiến bộ của bạn trong những năm gần đây và muốn gửi lời mời chính thức này để bạn tham gia hội nghị game lớn nhất hành tinh 'Games, Games, Games' còn được gọi là G3 (E3).{n}Bằng cách có gian hàng công ty của riêng bạn tại G3 (E3), bạn có thể thu hút rất nhiều người hâm mộ và tạo sự chú ý cho các trò chơi của mình và chúng tôi nghĩ rằng khán giả của chúng tôi sẽ rất muốn gặp bạn ở đó.\nChúng tôi sẽ liên hệ với bạn hàng năm về các lựa chọn gian hàng. Mong sớm gặp lại bạn tại G3 (E3).\nỦy ban G3 (E3)."
    }, {
        "value": "Goal Hint",
        "comment": "heading",
        ...
        "translation": "Cài đặt Mirconoft (Microsoft) BOSS (Microsoft MS-DOS) trên máy tính"
    }, {
        "value": "Debug program",
        "comment": "heading",
        ...
        "value": "Codename: Grid",
        "translation": "Mật danh: Grid (Steam)"
    }, {
        ...
        "translation": "Sếp ơi, xong rồi và nó đã hoạt động! Grid (Steam) là tên của nền tảng phân phối dựa trên internet của riêng chúng ta."
    }, {
        ...
        "translation": "Grid (Steam) sẽ tạo ra thu nhập hàng tháng, điều này sẽ thúc đẩy khả năng của chúng ta trong việc tạo ra các trò chơi mới và phát triển các dự án mới."
    }, {
        ...
        "value": "G3 Pixel Cup",
        "translation": "Cúp Pixel G3 (E3)"
    }, {
        "value": "G3 Code Jam",
        "translation": "G3 (E3) Code Jam"
    }, {
        "value": "G3 Game Jam",
        "translation": "G3 (E3) Game Jam"
    }, {
        "value": "G3 Time Trials",
        "translation": "Thử thách Thời gian G3 (E3)"
    }, {
        "value": "G3 Innovation Challenge",
        "translation": "Thử thách Sáng tạo G3 (E3)"
    }, {
        "value": "Book studies",
        ...
        "translation": "Đây là một gian hàng nhỏ dạng pop-up nơi chúng ta có thể trưng bày tài liệu marketing của mình. Nó không ấn tượng lắm nhưng là một kiểu thiết lập phổ biến tại G3 (E3)."
    }, {
        "value": "Medium Booth",
        "comment": "heading",
        ...
        "translation": "Với gói này, chúng ta sẽ có khu vực riêng trong sảnh chính của G3 (E3). Chúng ta có thể mong đợi một lượng lớn khách tham quan."
    }, {
        "value": "Custom",
        ...
        "comment": "heading",
        "translation": "Hội chợ Game: G3 (E3)"
    }, {
        "value": "{0} Convention",
        "comment": "heading",
        ...
        "translation": "Mirconoft (Microsoft) đã thông báo trì hoãn hệ máy chơi game mới của họ, mBox (Xbox). Ngày phát hành mới là '{0}'. Có tin đồn rằng thành công đáng kinh ngạc của việc ra mắt Playsystem (PlayStation) 2 (PlayStation 2) đã khiến Mirconoft (Microsoft) trì hoãn việc ra mắt sản phẩm của riêng mình."
    }, {
        ...
        "comment": "{0} is date referral sentence fragment",
        "translation": "Hôm nay, Ninvento (Nintendo) đã công bố một hệ máy di động mới có tên là Ninvento (Nintendo) GS (Nintendo DS). Nó có hai màn hình, một trong số đó có cảm ứng, và hứa hẹn lối chơi độc đáo. Mặc dù Ninvento (Nintendo) đã phải vật lộn để giành lại vị trí dẫn đầu thị trường kể từ TES (NES) 64 (NES 64), họ vẫn có một vị thế rất mạnh trên thị trường di động.{n}Ninvento (Nintendo) GS (Nintendo DS) hứa hẹn sẽ củng cố vị thế này và nhằm mục đích thổi luồng sinh khí mới vào thị trường di động đang trì trệ. Hệ máy này sẽ có mặt tại các cửa hàng {0}."
    }, {
        ...
        "comment": "{0} is date referral sentence fragment",
        "translation": "Hôm nay, Mirconoft (Microsoft) đã công bố thiết bị máy tính bảng của riêng họ để cạnh tranh với thị phần khổng lồ của thiết bị grPad (iPad) của Grapple (Apple). mPad (Microsoft Surface) có một vỏ bọc tinh xảo đi kèm với bàn phím siêu mỏng tích hợp. Bản thân máy tính bảng có màn hình rộng và chân đế tích hợp.{n}mPad (Microsoft Surface) dường như là sự kết hợp giữa máy tính xách tay truyền thống và máy tính bảng, và hứa hẹn sẽ làm rung chuyển thị trường. Sản phẩm mới sẽ có mặt trên thị trường {0}."
    }, {
        ...
        "comment": "{0} is date referral sentence fragment",
        "translation": "Đối với những người hâm mộ mBox (Xbox), sự chờ đợi một bản cập nhật cho hệ máy này sẽ sớm kết thúc khi Mirconoft (Microsoft) đã thông báo rằng mBox (Xbox) One (Xbox One) sẽ có mặt {0}."
    }, {
        ...
        "translation": "Ngay sau khi Mirconoft (Microsoft) công bố sản phẩm mới của họ trong thế hệ console sắp tới, Vonny (Sony) đã thông báo rằng họ sẽ phát hành hệ máy mới được chờ đợi từ lâu, Playsystem (PlayStation) 4 (Sony PlayStation 4), {0}. Hệ máy này dường như làm được mọi thứ mà Playsystem (PlayStation) 3 (Sony PlayStation 3) đã làm, chỉ có điều tốt hơn.{n}Không giống như mBox (Xbox) One (Xbox One), Playsystem (PlayStation) 4 (Sony PlayStation 4) không yêu cầu kết nối trực tuyến liên tục và có vẻ thân thiện với người chơi hơn nhiều. Chúng tôi nghĩ rằng khó có nguy cơ người hâm mộ Vonny (Sony) sẽ thất vọng"
    }, {
        "value": "Vonny and {0}",
        "translation": "Vonny (Sony) và {0}"
    }, {
        ...
        "translation": "Một công ty có tên RiseVR (Oculus) đã phát triển một bộ kính thực tế ảo hứa hẹn cuối cùng sẽ mở ra con đường hướng tới sự đắm chìm 3D thực sự. Bộ kính mới có tên Visorius (Oculus Rift) trông giống như một cặp kính trượt tuyết khổng lồ và cung cấp một trường nhìn rộng cũng như theo dõi chuyển động gần như hoàn hảo."
    }, {
        ...
        "comment": "{0} is date referral sentence fragment, sentence itself is a fragment and continues with 'but ...'",
        "translation": "Mirconoft (Microsoft) đã công bố kế hoạch phát hành một phiên bản hoàn toàn mới của mBox (Xbox) {0} có tên là mBox (Xbox) Next (Xbox Series X/S). Hệ máy mới dường như tích hợp một cách thông minh cảm biến chuyển động bổ trợ của Mirconoft (Microsoft) cho mBox (Xbox) One (Xbox One) vào một gói nhỏ gọn.{n}Về mặt hình ảnh, mBox (Xbox) Next (Xbox Series X/S) gợi nhớ đến mBox (Xbox) 360 (Xbox 360) trước đó với tông màu sáng hơn nhiều, đánh dấu sự khác biệt so với phong cách cồng kềnh và tối tăm của mBox (Xbox) One (Xbox One). Công nghệ của mBox (Xbox) Next (Xbox Series X/S) có vẻ hứa hẹn  "
    }, {
        ...
        "comment": "{0} is date referral sentence fragment, sentence itself is a fragment and continues with 'but ...'",
        "translation": "Nhiều người đã kỳ vọng rằng Vonny (Sony) sẽ công bố một nền tảng mới trước khi mBox (Xbox) Next (Xbox Series X/S) của Mirconoft (Microsoft) có mặt trên thị trường và hôm nay, Vonny (Sony) đã làm đúng như vậy. Giữ vững truyền thống của công ty, và trái ngược với cách đặt tên của đối thủ Mirconoft (Microsoft), hệ máy mới được công bố có tên rất phù hợp là Playsystem (PlayStation) 5 (Sony PlayStation 5).{n}Playsystem (PlayStation) 5 (Sony PlayStation 5) dường như là một bản cập nhật gia tăng, ra mắt {0} với kiểu dáng gợi nhớ đến Playsystem (PlayStation) 3 (Sony PlayStation 3) đời đầu. Hệ thống mới hứa hẹn sẽ là một bản cập nhật vững chắc"
    }, {
        ...
        "translation": "Sau phản ứng dữ dội của công chúng đối với các tính năng gây tranh cãi được công bố cho mBox (Xbox) One (Xbox One) sắp ra mắt, Mirconoft (Microsoft) hôm nay đã công bố một lá thư nêu rõ sự thay đổi kế hoạch của họ. mBox (Xbox) One (Xbox One) sẽ không còn yêu cầu kết nối internet liên tục và sẽ không đặt ra các hạn chế về cách bán hoặc chia sẻ trò chơi.{n}Rõ ràng là các chiến lược khác biệt và phổ biến hơn nhiều của các công ty như {0}, cũng như chính những người chơi lên tiếng, đã buộc phải thay đổi hướng đi này."
    }, {
        ...
        "translation": "Hỗ trợ Visorius (Oculus Rift)"
    }, {
        ...
        "comment": "{0} is date referral sentence fragment",
        "translation": "Ninvento (Nintendo) đã tiết lộ rằng sự tham gia của họ vào thế hệ console tiếp theo sẽ được gọi là Wuu (Wii U). Hệ máy mới này có một bộ điều khiển với màn hình tích hợp.{n}Điều này được cho là sẽ làm cho các trò chơi nhiều người chơi cục bộ trở nên thú vị hơn nhiều bằng cách cung cấp cho mỗi người chơi một màn hình độc đáo. Ninvento (Nintendo) luôn đi đầu trong đổi mới và hệ máy này dường như, một lần nữa, là một bước đi táo bạo.\nWuu được cho là sẽ có mặt {0}."
    }, {
        ...
        "translation": "Từ hư không, một công ty mới tên là KickIT (Kickstarter) đã gây bão truyền thông bằng cách huy động vốn cộng đồng thành công cho việc phát triển một hệ máy chơi game mới chỉ trong vòng chưa đầy tám giờ.{n}Hệ máy này, được mệnh danh là 'OYA (Ouya)', sử dụng công nghệ tương tự như điện thoại và máy tính bảng hiện đại và cung cấp game độc quyền qua cửa hàng trực tuyến của riêng mình.\nOYA là một hệ máy hình khối và nhỏ hơn nhiều so với hầu hết các tay cầm chơi game nhưng hình dạng không phải là thứ duy nhất nhỏ bé vì nhà phát triển tuyên bố rằng giá của OYA (Ouya) sẽ dưới 100cr.{n} KickIT (Kickstarter) cũng tuyên bố rằng mọi trò chơi trên OYA (Ouya) sẽ cung cấp bản DEMO miễn phí. OYA (Ouya) sẽ có mặt trên thị trường {0}."
    }, {
        "value": "Game dev gems",
        ...
        "translation": "- Gửi từ grPhone (iPhone) của tôi."
    }, {
        ...
        "comment": "{0} is date referral sentence fragment",
        "translation": "Hôm nay, Ninvento (Nintendo) đã tiết lộ hệ máy chơi game sắp ra mắt của họ: The Ninvento (Nintendo) Swap (Nintendo Switch). Thiết bị này dường như hoạt động như cả một hệ máy di động và một hệ máy gia đình. Khi Swap được tháo khỏi đế cắm, các tay cầm điều khiển độc đáo được gọi là 'Fun-Pads (Joy-Cons)' sẽ được gắn vào cạnh màn hình và biến hệ máy thành một thiết bị cầm tay.{n}Phản ứng đối với thông báo này khá trái chiều khi nhiều người bày tỏ lo ngại rằng thiết bị có thể không có đối tượng rõ ràng và có thể không thu hút được cả người chơi thông thường lẫn người chơi chuyên nghiệp. Những người khác ca ngợi tính chất độc đáo của thiết bị và chỉ ra rằng Ninvento (Nintendo) thường xuyên đạt được thành công với các thiết bị kỳ lạ trong quá khứ. Swap được cho là sẽ có mặt trên thị trường {0}."
    }, {
        ...
        "translation": "Hệ máy Ninvento (Nintendo) Swap (Nintendo Switch) mới ra mắt gần đây đã gây ra một cơn bão truyền thông xã hội bất thường. Mọi chuyện bắt đầu khi một người tiêu dùng liếm một trong những băng game và báo cáo rằng nó có vị cực kỳ tệ. Hàng ngàn người tiêu dùng sau đó đã lặp lại thử nghiệm, nếm thử băng game của họ và báo cáo kết quả trên mạng xã hội, tiếp tục khuyến khích những người khác làm điều tương tự.{n}Ninvento (Nintendo) hiện đã đưa ra một tuyên bố chính thức để xác nhận rằng các băng game cho Swap được phủ một lớp denatonium benzoate, một chất làm đắng không độc hại. Điều này rõ ràng được thực hiện để ngăn trẻ em cắn và nuốt những chiếc băng game khá nhỏ.{n}Phản ứng ban đầu đối với chính hệ máy này tích cực hơn so với vị của băng game của nó vì Swap đang tỏ ra khá phổ biến với các game thủ trên toàn cầu."
    }, {
